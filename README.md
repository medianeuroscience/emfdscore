## Automated Morality Extraction for Python <img src=https://github.com/medianeuroscience/pyamore/blob/master/pyamore_logo.png width="150" height="50"> ## Automated Morality Extraction for Python
